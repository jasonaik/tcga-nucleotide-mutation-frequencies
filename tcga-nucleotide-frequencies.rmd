...
pdf(glue("plots/{Sys.Date()}/mutation-bar-heat-pancan-alltops.pdf"), width = 18, height = 17)
grid.draw(final_plot)
dev.off()
...
pdf(glue("plots/{Sys.Date()}/gene-bar-heat-pancan-alltops.pdf"), width = 18, height = 17)
grid.draw(final_plot)
dev.off()
